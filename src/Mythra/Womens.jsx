...
<div className="link1">
        ...
        <div className="link1 ">
          ...
          >
            ...
            <Container fluid className="purchase bg-white mt-3">
                <Row>
                    <Col xs={3}>
                        <img src={jewel1} alt="Women's Jewel 1" style={{ width: "100%" }} />
                    </Col>
                    <Col xs={3}>
                        <img src={jewel2} alt="Women's Jewel 2" style={{ width: "100%" }} />
                    </Col>
                    <Col xs={6} className="p-2">
                        <h2 className="text-primary"><b>Elegant Sparkle Necklace</b></h2>
                        <p>Women's 18K Gold Plated Pendant Necklace</p>
                        <img src={star1} style={{ width: "150px" }} alt="Rating" />
                        <hr />
        ...
        <Row>
         ...
         This jewellery set consists of a necklace and a pair of earrings
         necklace has Kundan details
         Secured with a lobster closure
         ...
         <p style={{fontWeight:"normal"}}> Stone Type
         </p>
         <h6> Kundan </h6>
         <hr></hr>
         ...
         <hr></hr>
                ...
                <Row>
                    ...
                    <Col xs={6}>
                        ...
                        <img src={rate2} style={{ width: "50%" }} alt="Star Rating" />
                        <hr />
