...
export default function Kids() {
    ...
    const sizes = ["One Size"]; // Example size for Kids item
...
<div className="link1">
       ...
       <Row className="mt-3">
         ...
         <br />
         <input type="pincode" placeholder="Enter Your PinCode" style={{width:"35%" , padding:"10px"}} />
         <h6 className="mt-1"> Please enter PIN code to check delivery time & Pay on Delivery Availability </h6>
         <br />
         <p style={{fontWeight:"normal"}}> 100% Original Products </p>         <p style={{fontWeight:"normal"}}> Pay on delivery might be available </p>
       ...
       <Row>
         ...
         <h5> Features </h5>
         <p style={{fontWeight:"normal"}}> 
         Introducing the Baybee 2 in 1 Furitto Baby Tricycle the perfect way to keep your little one entertained and safe! Built to last, this tricycle is designed to cater to your child's growing needs. Suitable for children between 2 and 5 years, this tricycle comes with adjustable push handle, rubber wheels, and a safety belt for added safety and comfort
         ...
         Vibrant Design: The tricycle has a modern and eye-catching design with a bright yellow color to match your childs taste
         Durability: Constructed with top-quality materials, this tricycle is designed to last through your childs growth
         </p>
         ...
         <p style={{fontWeight:"normal"}}> Material
         </p>
         <h6> Metal</h6>
         <hr></hr>
         ...
         <p style={{fontWeight:"normal"}}> MulitiPack Set </p>
         <h6> Single  </h6>
         <hr></hr>
           </Col>
         </Row> 
